...
CREATE TABLE IF NOT EXISTS `batch` (
  `batch_id`           INT           NOT NULL AUTO_INCREMENT  COMMENT '批次号',
...
CREATE TABLE IF NOT EXISTS `inventory` (
  ...
  `warehouse_id`     INT           NOT NULL                 COMMENT '实际所在库房ID',
  `zone_id`          INT           NOT NULL                 COMMENT '实际所在库区ID',
  `location_id`      INT           NOT NULL                 COMMENT '实际所在库位ID',
...
CREATE TABLE IF NOT EXISTS `quality_check_detail` (
  ...
  `goods_id`           INT           NOT NULL                 COMMENT '货物ID',
  `batch_id`           INT           NOT NULL                 COMMENT '批次ID',
  `location_id`        INT           DEFAULT NULL             COMMENT '所在库位ID',
